...
- Created the Chasten config file for my checks
- Worked with Miles and Baysaa to combine our checks and the ones pulled from Zhu to create a comprehensive file
- Wrote descriptions for the checks
